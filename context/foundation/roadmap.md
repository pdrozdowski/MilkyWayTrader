...
| S-08 | s08-asteroid-combat | User can fire the ship weapon and fragment or destroy asteroids. | S-07 | US-04, FR-031, FR-033, FR-034 | proposed |
...
| S-10 | s10-player-sign-in-status | User can sign in for persistent features and inspect authentication status. | Selected identity-provider test projects configured | US-05, FR-037, FR-038 | blocked |
...
- **Change ID:** s02-direct-moving-system-flight
...
- **Change ID:** s03-guided-orbit-and-landing
...
- **Change ID:** s06-timed-debt-outcome
...
- **S-02: User can fly directly through a moving, identifiable solar system.** — Archived 2026-09-25 → `context/archive/2026-09-23-s02-direct-moving-system-flight/`. Lesson: —.
